                    ...
                    <form role="form" method="POST">
                      <div class="form-group">
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" id="nuevoVendedor" name="nuevoVendedor" placeholder="Vendedor" readonly>
                        </div>
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" id="nuevaVenta" name="nuevaVenta" placeholder="1000231" readonly>
                        </div>
                      </div>

                      <div class="form-group">
                        <div class="input-group mb-3">
                          <select class="form-control select2" style="width: 80%;" name="nuevoPerfil">
